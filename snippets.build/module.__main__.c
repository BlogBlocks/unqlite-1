...
static PyObject *const_str_digest_4312ef25d5000c1d1d2e15d2bff3c62c;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_4312ef25d5000c1d1d2e15d2bff3c62c = UNSTREAM_STRING( &constant_bin[ 121 ], 30, 0 );
    const_str_plain_c = UNSTREAM_CHAR( 99, 1 );
    const_str_plain_execute = UNSTREAM_STRING( &constant_bin[ 151 ], 7, 1 );
    const_str_plain_raw_input = UNSTREAM_STRING( &constant_bin[ 158 ], 9, 1 );
...
static PyCodeObject *codeobj_a898acd659e452b48cc52f304430cf5c;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_4312ef25d5000c1d1d2e15d2bff3c62c;
    codeobj_a898acd659e452b48cc52f304430cf5c = MAKE_CODEOBJ( module_filename_obj, const_str_angle_module, 1, const_tuple_empty, 0, CO_NOFREE );
    codeobj_main = codeobj_a898acd659e452b48cc52f304430cf5c;
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_a898acd659e452b48cc52f304430cf5c;

    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;

    // Module code.
    // Frame without reuse.
    frame_a898acd659e452b48cc52f304430cf5c = MAKE_MODULE_FRAME( codeobj_a898acd659e452b48cc52f304430cf5c, module___main__ );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_a898acd659e452b48cc52f304430cf5c );
    assert( Py_REFCNT( frame_a898acd659e452b48cc52f304430cf5c ) == 2 );

    // Framed code:
    tmp_name_name_1 = const_str_plain_os;
    tmp_level_name_1 = const_int_0;
    frame_a898acd659e452b48cc52f304430cf5c->m_frame.f_lineno = 1;
    ...
    tmp_assign_source_2 = const_str_digest_4312ef25d5000c1d1d2e15d2bff3c62c;
    ...
    frame_a898acd659e452b48cc52f304430cf5c->m_frame.f_lineno = 2;
    ...
    frame_a898acd659e452b48cc52f304430cf5c->m_frame.f_lineno = 3;
    ...
    frame_a898acd659e452b48cc52f304430cf5c->m_frame.f_lineno = 4;
    ...
    frame_a898acd659e452b48cc52f304430cf5c->m_frame.f_lineno = 5;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_a898acd659e452b48cc52f304430cf5c );
#endif
    popFrameStack();

    assertFrameObject( frame_a898acd659e452b48cc52f304430cf5c );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_a898acd659e452b48cc52f304430cf5c, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_a898acd659e452b48cc52f304430cf5c->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_a898acd659e452b48cc52f304430cf5c, exception_lineno );
    }
